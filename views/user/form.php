 <div class="container container-dashboard f-column">
   ...
   <section class="dashboard-header bg-blue">
     <?php include 'views/includes/header-action.php'; ?>
   </section>

   <section class="bg-white dashboard-content shadow-sm">
     <form class="form" action="<?= $urlForm ?>" method="post" enctype="multipart/form-data">
         ...
         <fieldset class="fieldset col-6 col-12-md pd-r-1 pd-r-0-md">
           ...
           <div class="d-flex f-wrap">
             <div class="form-box-input col-6 pd-r-1 pd-r-0-md col-12-md">
               ...
               <input class="ipt ipt-default" id="name" name="name" type="text" value="<?= $user['name'] ?>" minLength="3" maxLength="32" required />
             </div>
             <div class="form-box-input col-6 col-12-md">
               <label class="label" for="lastname">Apellidos</label>
               <input class="ipt ipt-default" id="lastname" name="lastname" type="text" value="<?= $user['lastname'] ?>" minLength="3" maxLength="32" required />
             </div>
             <div class="form-box-input col-12">
               <label class="label" for="email">Email</label>
               <input class="ipt ipt-default" id="email" name="email" type="email" value="<?= $user['email'] ?>" maxLength="128" required />
             </div>
             <div class="form-box-input col-12">
               <label class="btn btn-blue" for="image" aria-describedby="image-help">Imagen</label>
               <input class="d-none" id="image" name="image" type="file" accept="<?= ALLOW_IMAGES ?>" />
